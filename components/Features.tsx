      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20 text-center">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Bizning platformamiz shunchaki diktofon emas. Bu to'liq sun'iy
            intellekt studiyasi.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          ...
          <div className="md:col-span-2 bg-gradient-to-br from-emerald-900/20 to-dark-900 rounded-3xl p-8 border border-emerald-500/20 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-400 mb-6 text-lg">
                Google Gemini 3.0 Flash Native Audio modeli bilan ishlaydi. Ovoz
                backend proxy orqali xavfsiz Google serverlariga uzatiladi.
              </p>
              <div className="flex gap-4">
                <span className="px-3 py-1 rounded-md bg-dark-800 border border-dark-700 text-xs text-emerald-400 font-mono">
                  16kHz PCM
                </span>
                <span className="px-3 py-1 rounded-md bg-dark-800 border border-dark-700 text-xs text-emerald-400 font-mono">
                  Secure Proxy
          ...
          <div className="bg-dark-900 rounded-3xl p-8 border border-dark-800 hover:border-dark-700 transition-colors">
            ...
            <p className="text-slate-400 text-sm mb-4">
              "Soft & Easy" dizayni. Barcha tugmalar bosh barmog'ingiz yetadigan
              joyda joylashgan.
            </p>
          ...
          {FEATURES.slice(0, 3).map((feature, idx) => (
            <div
              key={idx}
              className="bg-dark-900 p-6 rounded-3xl border border-dark-800 hover:bg-dark-800/50 transition-colors"
            >
        ...
        <div className="border-t border-dark-800 pt-16">
          <h3 className="text-center text-slate-500 text-sm uppercase tracking-widest mb-10">
            Texnologik Stack
          </h3>
          <div className="flex flex-wrap justify-center gap-4 md:gap-12 opacity-70">
            {[
              ...
              <span
                key={tech}
                className="text-xl md:text-2xl font-bold text-slate-300 hover:text-emerald-400 transition-colors cursor-default"
              >
                {tech}
              </span>
            ))}
